...
unlisted: true
---
Campaign-specific parameters on top of the generic [[How to Create a Hero]] procedure (core rules). Use this page for anything about hero creation that's specific to the Prison of Vhar'Ghul campaign rather than to Path to Glory in general.

## Starting Points

Starting Order of Battle (step 3 of the core procedure) is capped at **1,000pts** for this campaign, including the Warlord.
...
- **Every player earns a flat +100 Glory bonus at the end of Round 4, on top of the normal table.**
- **Every player earns a flat +100 Glory bonus at the end of Round 5, on top of the normal table.**

This applies regardless of win/loss — it's a campaign-wide escalation bonus, not a performance reward. Log it as its own line (or folded into Glory Earned) on the [[Stats|Glory & Renown Ledger]] so it's clear where the extra Glory came from.

## The Final Muster (Round 5 aftermath only)
