...
![Deployment Map](https://lh3.googleusercontent.com/pw/AP1GczNqgbDn24UFwv6sRimsQevSzqS06BOuTEkzQQ-9Cb2hJeWAz29Hnv-4MgMxvjK3XbVxR0BWPM_QMgHHyoGB076jIlL-TAwGmQQwbSftOREKSs6TrZ0=w2400)
...
- [ ] Record who controls the Ashen Vault and which epilogue applies (Champion victory vs. broken-alliance stalemate)
- [ ] Glory earned this final game, per player — log on the [[Stats|Glory & Renown Ledger]] for the record:
	- Scenario 5 victor: ___ Glory
	- Ally 1: ___ Glory
	- Ally 2: ___ Glory
	*(1751–2250pts tier: 100 base + up to 40 for a major win (30 minor) + up to 15 for General survived — [source](https://wahapedia.ru/aos4/the-rules/ascension/))*
- [ ] **Renown per unit** logged on [[Stats|Order of Battle]] — final entries for the campaign:
...
- [ ] Campaign complete — no further rounds to prep for
