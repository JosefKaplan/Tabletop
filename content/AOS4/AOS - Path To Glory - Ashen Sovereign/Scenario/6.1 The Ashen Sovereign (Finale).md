...
- [ ] Glory earned this final game, per player — log on the [[Stats|Glory & Renown Ledger]] for the record:
	...
	- Ally 1: ___ Glory
	- Ally 2: ___ Glory
	*(rough reference only, not an official value: ~65–110 Glory for a 2000pts game)*
- [ ] Renown per unit logged on [[Stats|Order of Battle]] (d3 survived / 1 taken out of action / +d6 Favoured Warriors) — final entries for the campaign
